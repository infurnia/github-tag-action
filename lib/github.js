...
function listTags(shouldFetchAllTags = false, fetchedTags = [], page = 1) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tags = yield octokit.repos.listTags(Object.assign(Object.assign({}, context.repo), { per_page: 100, page }));
...
function compareCommits(baseRef, headRef) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [owner, repo] = core.getInput('repository').split('/');
        const context = { repo: { owner: owner, repo: repo } };
        const commits = yield octokit.repos.compareCommits(Object.assign(Object.assign({}, context.repo), { base: baseRef, head: headRef }));
...
function createTag(newTag, createAnnotatedTag, GITHUB_SHA) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (createAnnotatedTag) {
            ...
            annotatedTag = yield octokit.git.createTag(Object.assign(Object.assign({}, context.repo), { tag: newTag, message: newTag, object: GITHUB_SHA, type: 'commit' }));
        }
        core.debug(`Pushing new tag to the repo.`);
        yield octokit.git.createRef(Object.assign(Object.assign({}, context.repo), { ref: `refs/tags/${newTag}`, sha: annotatedTag ? annotatedTag.data.sha : GITHUB_SHA }));
    });
}
